...
class Pyboard:
    def __init__(self, device, baudrate=115200, user='micro', password='python', wait=0, rawdelay=0, boardreset="{}", file_empty="main.py"):
        ...
        if device and device[0].isdigit() and device[-1].isdigit() and device.count('.') == 3:
            ...
            for attempt in range(wait + 1):
                try:
                    self.serial = serial.Serial(device, baudrate=baudrate, interCharTimeout=10, writeTimeout=2, timeout=40)
                    break
    ...
    def enter_raw_repl(self):
        ...
        for retry in range(10):
            ...
            if data.endswith(b'>'):
                ...
                sys.stdout.flush()      
                self.serial.write(bytes("import uos; uos.remove('{}')\r\n".format(self.file_empty), encoding="utf8"))
                time.sleep(0.1) 
