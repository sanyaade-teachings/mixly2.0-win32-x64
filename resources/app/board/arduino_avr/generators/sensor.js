...
Blockly.Arduino.MPU6050 = function() {
 ...
 Blockly.Arduino.setups_['setup_ngyro'] = 'Wire.begin();\n  mpu6050.begin();\n  mpu6050.calcGyroOffsets(true);';
...
Blockly.Arduino.encoder_init1 = function() {
  ...
  var DT = this.getFieldValue('DT');
  var Encoder_NO= this.getFieldValue('Encoder_NO');
  Blockly.Arduino.definitions_['var_declare_Encoder_' +Encoder_NO+ ''] ='int encoder_counter_' +Encoder_NO+ ' = 0;\n'
                                                                       +'int encoder_aState_' +Encoder_NO+ ';\n'
                                                                       +'int encoder_aLastState_' +Encoder_NO+ ';\n'
  Blockly.Arduino.setups_['setups_encoder_' +Encoder_NO+ ''] = '  pinMode ('+CLK+', INPUT);\n'
                                                              +'  pinMode ('+DT+', INPUT);\n'
