...
//显示-OLED-设置字体
Blockly.Blocks.oled_set_ZH_TW_Font = {
  init: function () {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .appendField(Blockly.DISPLAY)
    .appendField(new Blockly.FieldTextInput("u8g2"), "NAME")
    .appendField(Blockly.set_ZH_TW_Font);
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.oled_setFont_tooltip);
...
Blockly.Blocks.TFT_init_with_pin = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .setAlign(Blockly.ALIGN_RIGHT)
    ...
    this.appendDummyInput()
    .appendField(new Blockly.FieldDropdown([
      [Blockly.MIXLY_STM32_TFT_GREENTAB + "(ST7735)", "INITR_GREENTAB"],
      [Blockly.MIXLY_STM32_TFT_REDTAB + "(ST7735)", "INITR_REDTAB"],
      [Blockly.MIXLY_STM32_TFT_BLACKTAB + "(ST7735)", "INITR_BLACKTAB"],
...
//显示汉字（使用位图显示）
Blockly.Blocks.TFT_st7735_show_hz= {
  init: function() { 
    this.appendDummyInput()  
    .appendField("TFT")
    .appendField(Blockly.TFT_DISPLAY_CHINESE_CHARACTERS);
    this.appendDummyInput()  
...
Blockly.Blocks.TFT_color_seclet = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .setAlign(Blockly.ALIGN_RIGHT)
...
Blockly.Blocks.TFT_fillScreen = {
  init: function () {
    ...
    this.appendDummyInput("")
    .appendField("TFT")
    .appendField(Blockly.MIXLY_BACKGROUND_COLOR);
    this.appendDummyInput("")
...
//显示-TFT-定义字模名称和数据
Blockly.Blocks['tft_define_bitmap_data'] = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .appendField("TFT")
...
Blockly.Blocks['tft_generate_bitmap_data'] = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
        .appendField(new Blockly.FieldImage("../common/media/btn/setting.png", 20, 20, "*", () => {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      switch (mark) {
        ...
        case 3:
          ...
          break;
        default:
          let hexData = pixelData.toString(16);
          let addition = '';
...
//显示-TFT-画直线
Blockly.Blocks.tft_drawFastLine = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .appendField("TFT")
...
//显示-TFT-显示字符串
Blockly.Blocks.tft_print_refresh = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .appendField("TFT")
...
Blockly.Blocks.display_TM1637_init_32 = {
  init: function () {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .appendField(Blockly.MIXLY_4DIGITDISPLAY + "TM1637")
...
Blockly.Blocks.display_TM1637_displyPrint_32 = {
  init: function () {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendValueInput("VALUE")
    .setAlign(Blockly.ALIGN_RIGHT)
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(Blockly.MIXLY_4DIGITDISPLAY_TM1637_DISPLAYSTRING_TIP1);
  }
};
var display_Time_Point = [
[Blockly.MIXLY_4DIGITDISPLAY_ON, "true"],
...
Blockly.Blocks.display_TM1637_displayTime_32 = {
  init: function () {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .appendField(Blockly.MIXLY_4DIGITDISPLAY + "TM1637")
    ...
    .appendField(Blockly.MIXLY_MINUTE);
     //  .appendField(new Blockly.FieldDropdown([[Blockly.MIXLY_ON, "displayOn"], [Blockly.MIXLY_OFF, "displayOff"], [Blockly.MIXLY_LCD_STAT_CLEAR, "clear"]]), "STAT");
     this.appendDummyInput("").appendField(Blockly.MIXLY_DISPLAY_TM1637_Time_Point).appendField(new Blockly.FieldDropdown([[Blockly.MIXLY_ON, "(0x80 >> 1)"], [Blockly.MIXLY_OFF, "(0x80 >> 2)"]]), "STAT");
 ...
 Blockly.Blocks.display_TM1637_Brightness_32 = {
  init: function () {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("")
    .appendField(Blockly.MIXLY_4DIGITDISPLAY + "TM1637")
...
Blockly.Blocks.display_TM1637_clearDisplay_32 = {
  init: function () {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput()
    .appendField(Blockly.MIXLY_4DIGITDISPLAY + "TM1637")
    .appendField(new Blockly.FieldTextInput("display"), "NAME")
    .appendField(new Blockly.FieldDropdown([[Blockly.MIXLY_LCD_STAT_CLEAR, "clear"]]), "STAT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(Blockly.MIXLY_4DIGITDISPLAY_TM1637_CLEARDISPLAY);
  }
