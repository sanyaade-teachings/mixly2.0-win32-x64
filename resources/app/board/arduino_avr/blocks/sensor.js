...
Blockly.Blocks.MPU6050= {
  init: function() {
    ...
    .appendField(new Blockly.FieldDropdown([
      [Blockly.MIXLY_Accel_X, "getAccX()"], 
      [Blockly.MIXLY_Accel_Y, "getAccY()"], 
      [Blockly.MIXLY_Accel_Z, "getAccZ()"],
      [Blockly.MIXLY_Gyro_X, "getAngleX()"],
      [Blockly.MIXLY_Gyro_Y, "getAngleY()"],
      [Blockly.MIXLY_Gyro_Z, "getAngleZ()"],
      [Blockly.MIXLY_readTempC, "getTemp()"]
      ]), "MPU6050_TYPE");
    this.setInputsInline(true);
    this.setOutput(true);
  }
