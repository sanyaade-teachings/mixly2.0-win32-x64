...
Blockly.Python.sensor_aht11=function(){
    var sub = Blockly.Python.valueToCode(this, 'SUB', Blockly.Python.ORDER_ATOMIC);
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_mixgo_cc_onboard_ahtx0'] = "from mixgo_cc import onboard_ahtx0";
...
Blockly.Python.rfid_readid=function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_mixgo_cc_onboard_rc522'] = "from mixgo_cc import onboard_rc522";
