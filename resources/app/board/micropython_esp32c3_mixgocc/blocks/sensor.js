...
Blockly.Blocks['sensor_hp203'] = {
    init: function(){
        ...
        .appendField(new Blockly.FieldDropdown([
            ...
            [Blockly.MIXLY_GETTEMPERATUE, "altitude()"],
            [Blockly.MIXLY_GET_ALTITUDE, "temperature()"],
            ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['sensor_mixgome_button_is_pressed'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendValueInput('btn')
        .appendField(Blockly.MIXLY_BUTTON)
...
Blockly.Blocks['sensor_mixgome_button_was_pressed'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendValueInput('btn')
        .appendField(Blockly.MIXLY_BUTTON)
...
Blockly.Blocks['sensor_mixgome_button_get_presses'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendValueInput('btn')
        .appendField(Blockly.MIXLY_BUTTON)
...
Blockly.Blocks.sensor_mixgome_button_attachInterrupt = {
  init: function() {
    this.setColour(Blockly.Blocks.sensor.HUE);
    this.appendValueInput("btn")
    .appendField(Blockly.MIXLY_ESP32_INTERRUPT)
...
Blockly.Blocks['sensor_mixgome_pin_near'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendDummyInput()
            .appendField(Blockly.MIXLY_ESP32_EXTERN_NEAR);       
...
Blockly.Blocks['sensor_mixgome_lm35'] = {
  init: function() {
    this.setColour(Blockly.Blocks.sensor.HUE);
    this.appendDummyInput("")
    .appendField("LM35"+Blockly.MIXLY_TEMP);
...
Blockly.Blocks['sensor_mixgome_LTR308'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendDummyInput()
            .appendField(Blockly.MIXLY_ESP32_LIGHT);
...
Blockly.Blocks['sensor_mixgome_sound'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendDummyInput()
            .appendField(Blockly.MIXLY_ESP32_SOUND);
...
Blockly.Blocks['sensor_mixgome_get_acceleration'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendDummyInput()
        .appendField(Blockly.MIXLY_MICROBIT_JS_ACCELERATION)
