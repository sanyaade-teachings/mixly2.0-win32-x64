...
var indexText = {
    ...
    "上传失败": "上传失败",
    "无可用设备": "无可用设备",
    "检测到多个串口，请选择：": "检测到多个串口，请选择：",
    "检测到多个同类型设备，请选择：": "检测到多个同类型设备，请选择：",
    "写文件出错了，错误是：": "写文件出错了，错误是：",
    "用时": "用时",
    "保存": "保存",
    "保存中": "保存中",
    "保存成功": "保存成功",
    "所打开文件可直接上传": "所打开文件可直接上传",
    "取消": "取消",
    "上传": "上传",
    "此功能暂不可用": "此功能暂不可用",
    "拷贝库": "拷贝库",
    ...
    "导入库": "导入库",
    "进度": "进度",
    "请选择至少一个云端库": "请选择至少一个云端库",
    "编辑url": "编辑url",
    "导入中": "导入中",
    "管理库": "管理库",
    "请选择至少一个已导入的库": "请选择至少一个已导入的库",
    "确定": "确定",
    "替换文件": "替换文件",
    "另存为": "另存为",
    "打开": "打开",
    "错误：无法从 mix 中读取板卡信息！！": "错误：无法从 mix 中读取板卡信息！！",
    "无效的文件类型！(支持.ino|.xml|.mix|.py|.hex文件)": "无效的文件类型！(支持.ino|.xml|.mix|.py|.hex文件)",
    "无效的mix文件": "无效的mix文件",
    "程序正在运行": "程序正在运行",
    "程序运行完成": "程序运行完成",
    "无程序在运行": "无程序在运行",
    ...
    "忽略未定义块": "忽略未定义块",
    "读取代码": "读取代码",
    "一些图形化模块尚未定义": "一些图形化模块尚未定义",
    "选择串口": "选择串口",
    "无可用串口": "无可用串口",
    "查找": "查找",
    "共搜索到图形块": "共搜索到图形块",
    "显示": "显示",
    "请添加关键词以显示全部。例如：管脚 数字": "请添加关键词以显示全部。例如：管脚 数字",
    "无数据": "无数据",
    "未找到Wiki页": "未找到Wiki页",
    "打开Wiki": "打开Wiki",
    "首页": "首页",
...
/* 背包 */
Blockly.Msg.COPY_ALL_TO_BACKPACK = '复制所有图形块到背包';
Blockly.Msg.COPY_TO_BACKPACK = '加入背包';
Blockly.Msg.EMPTY_BACKPACK = '清空';
Blockly.Msg.PASTE_ALL_FROM_BACKPACK = '提取背包中的所有图形块';
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "返回指定弧度的余弦值。";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "返回指定弧度的正弦值。";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "返回指定弧度的正切值。";
Blockly.Msg.ME = "我";
...
Blockly.LANG_LISTS_GET_INDEX_TOOLTIP = '返回数组中指定位置的值，索引从1开始。';
Blockly.LANG_LISTS_SET_INDEX1 = '的第';
Blockly.LANG_LISTS_SET_INDEX2 = '项赋值为';
Blockly.LANG_LISTS_SET_INDEX_TOOLTIP = '设置数组中指定位置的值，索引从1开始。';
...
Blockly.MIXLY_4DIGITDISPLAY_TM1637_DISPLAYSTRING_TIP1 = '最多显示4位数字，多余4位数字无效。';
...
Blockly.MIXLY_RGB_NUM_R_G_B = "设置RGB彩灯模块指定灯的R值,G值,B值，灯号从1开始";
Blockly.MIXLY_RGB_NUM_R_G_B_MIXGOCC = "设置RGB彩灯模块指定灯的R值,G值,B值，灯号从0到3";
Blockly.MIXLY_RGB_ALL_R_G_B_MIXGOCC = "设置全部RGB彩灯模块的R值,G值,B值";
Blockly.MIXLY_RGB_NUM_R_G_B_MIXGOME = "设置RGB彩灯模块指定灯的R值,G值,B值，灯号从0到1";
Blockly.MIXLY_RGB_NUM_R_G_B_MPYTHON = "设置RGB彩灯模块指定灯的R值,G值,B值，灯号从0到2";
...
Blockly.MIXLY_MICROBIT_Shiliang_Direction = "x,y,z矢量和";
...
Blockly.MIXLY_DISPLAY_VLINE = "竖直";
...
Blockly.ESP32_SENSOR_NIXGO_LIGHT_TOOLTIP = '返回光线传感器的值（0~65535）';
Blockly.ESP32_SENSOR_NIXGO_SOUND_TOOLTIP = '返回声音传感器的值（0~65535）';
...
Blockly.MIXLY_ESP32_INOUT_PWM_ANALOG_WRITE_TOOLTIP = "设置某管脚模拟输出的值（0~65535）";
...
Blockly.MIXLY_ESP32_SHOW_IMAGE_OR_STRING = '显示(图像/字符串)';
...
Blockly.MPYTHON_BLYNK_SET_PROPERTY_TOOLTIP = "给虚拟管脚添加颜色值";
Blockly.MPYTHON_BLYNK_EMAIL_HELPURL = '';
Blockly.MPYTHON_BLYNK_EMAIL_MESSAGE0 = '向 %1 发邮件 主题 %2 正文 %3';
Blockly.MPYTHON_BLYNK_EMAIL_TOOLTIP = '向对象发送邮件，标明主题，标明正文';
...
Blockly.MPYTHON_BLYNK_APP_NOTIFY_TOOLTIP = 'Blynk App 显示通知';
...
Blockly.MPYTHON_BLYNK_APP_DATA_TOOLTIP = '收到虚拟管脚的值后执行一些语句';
Blockly.MPYTHON_BLYNK_SETUP_HELPURL = '';
Blockly.MPYTHON_BLYNK_SETUP_MESSAGE0 = 'Blynk 设置 %1 服务器 %2 端口 %3 授权码 %4';
Blockly.MPYTHON_BLYNK_SETUP_TOOLTIP = '服务器默认为 blynk.mixly.org，端口默认为 8080，授权码默认为 AUTH TOKEN';
...
Blockly.set_ZH_TW_Font = '设置繁体中文';
Blockly.ADS1015_Get_Value = '模数转换模块';
Blockly.ADS1015_setGain = "ADS1015采样范围和精度";
Blockly.MIXLY_MP3_UDISK = '优盘';
Blockly.MIXLY_MP3_SOURCE = '播放来源';
Blockly.QJ00X_MP3 = 'QJ00X MP3模块';
Blockly.MIXLY_IR_RANGE = '双红外测距';
Blockly.MIXLY_LASER_RANGE = '激光测距仪';
Blockly.MIXLY_TEM_HUM = '温湿度传感';
Blockly.MIXLY_GET_ALTITUDE = '获取海拔高度';
Blockly.MIXLY_GET_LIGHT_INTENSITY = '获取光线强度';
Blockly.MIXLY_GET_DISTANCE = '获取距离';
Blockly.MIXLY_EMQX_PROJECT = '项目';
Blockly.MIXLY_ESP32_INITIAL_DIGITAL_TUBEFOOT = '初始化输入的某个管脚为数字管脚并编号';
Blockly.MIXLY_ESP32_DIGITALINOUT_MODE = '为某个数字管脚设置输入或输出类型';
Blockly.MIXLY_ESP32_S2_SET_RAW_TIME = '获取并返回所选时间的格式化时间';
Blockly.MIXLY_ESP32_SET_ONBOARD_MUSIC_STOP = '结束在播放的声音';
Blockly.MIXLY_ESP32_ROLL_SHOW_STRING = '在屏幕上滚动显示字符串';
Blockly.MPYTHON_BLYNKTIMER_TOOL = '确定可用定时器';
Blockly.MPYTHON_BLYNK_STOP_TIMERS = '停止相应定时器';
Blockly.MPYTHON_BLYNK_SENSOR_DATA_TO_APP_TOOLTIP = '发送数据到虚拟管脚';
Blockly.MIXLY_ESP32_IOT_WIFI_RADIO_CONNECT_TOOLTIP = '连接用户名为某某，密码为某某的WiFi';
Blockly.MIXLY_ESP32_IOT_WIFI_RESET_TOOLTIP = 'WiFi复位';
Blockly.MIXLY_ESP32_IOT_EMQX_INIT_TOOLTIP = '服务器地址默认为 39.101.161.127，代理网口默认为 1883，输入用户名，输入密码，输入项目，为WiFi创建连接池，SSL默认上下文';
Blockly.MIXLY_ESP32_IOT_EMQX_PUBLISH_TOOLTIP = '发送某一主题的消息';
Blockly.MIXLY_ESP32_IOT_EMQX_PUBLISH_MORE_TOOLTIP = '发送某一主题的消息，设置发送位置，设置代理保存情况，设置服务质量';
Blockly.MIXLY_ESP32_IOT_EMQX_SUBSCRIBE_TOOLTIP = '订阅主题';
Blockly.MIXLY_ESP32_IOT_EMQX_SUBSCRIBE_MORE_TOOLTIP = '订阅主题，设置服务质量';
Blockly.MIXLY_ESP32_IOT_EMQX_UNSUBSCRIBE_TOOLTIP = '取消订阅主题';
Blockly.MIXLY_ESP32_IOT_EMQX_LOOP_TOOLTIP = '循环接收订阅';
Blockly.MIXLY_ESP32_IOT_EMQX_CONNECT_TOOLTIP = 'MQTT 连接';
Blockly.MIXLY_ESP32_IOT_EMQX_DISCONNECT_TOOLTIP = 'MQTT 断开连接';
Blockly.MIXLY_ESP32_IOT_EMQX_IS_CONNECT_TOOLTIP = '判断 MQTT 是否连接成功';
Blockly.MIXLY_ESP32_IOT_EMQX_RECONNECT_TOOLTIP = 'MQTT 重新连接';
Blockly.MIXLY_ESP32_IOT_EMQX_PING_TOOLTIP = 'MQTT 服务端响应情况';
Blockly.MIXLY_ESP32_IOT_EMQX_ENABLE_LOGGER_TOOLTIP = '启用日志，设置级别';
Blockly.MIXLY_ESP32_IOT_EMQX_ADD_TOPIC_CALLBACK_TOOLTIP = '为某主题设置回调函数';
Blockly.MIXLY_ESP32_IOT_EMQX_REMOVE_TOPIC_CALLBACK_TOOLTIP = '为某主题清除回调函数';
Blockly.MIXLY_ESP32_IOT_EMQX_USERNAME_PW_SET_TOOLTIP = '设置用户名和密码';
Blockly.MIXLY_ESP32_IOT_MAP_FORMATING = '格式化位置信息';
Blockly.MIXLYCAR_WHEEL_LEFT_UP = '左前轮';
Blockly.MIXLYCAR_WHEEL_LEFT_DOWN = '左后轮';
Blockly.MIXLYCAR_WHEEL_RIGHT_UP = '右前轮';
Blockly.MIXLYCAR_WHEEL_RIGHT_DOWN = '右后轮';
Blockly.MIXGO_WAVE = '播放波形声音';
Blockly.MIXGO_WAVE_IS_PLAYING = '波形声音在播放吗？';
Blockly.MIXGO_LEFT_MID = '左中';
Blockly.MIXGO_RIGHT_MID = '右中';
Blockly.MIXGO_LEFT_FRONT = '左前';
Blockly.MIXGO_RIGHT_FRONT = '右前';
Blockly.MIXGO_LEFT_BACK = '左后';
Blockly.MIXGO_RIGHT_BACK = '右后';
Blockly.MIXGO_LINE_SENSOR = '巡线传感器状态';
Blockly.MIXGO_PROXIMITY_SENSOR = '接近传感器数值';
Blockly.MIXGO_ACC_8658_SENSOR = '获取六轴加速度传感器';
Blockly.MIXGO_CAR_READBUSY = '是否运动？';
Blockly.MIXGO_CE_SPEAKER = '扬声器';
Blockly.MIXGO_CAR_KEEP_FORWARD = '持续前进';
Blockly.MIXGO_CAR_KEEP_BACK = '持续后退';
Blockly.MIXGO_CAR_KEEP_LEFT = '持续左转';
Blockly.MIXGO_CAR_KEEP_RIGHT = '持续右转';
Blockly.MIXLY_DewPoint = '结露点';
Blockly.WeatherGet = '刷新天气 城市 ';
Blockly.WeatherGetToday = '获取今日数据';
Blockly.TodayQuality = '空气质量';
Blockly.WeatherGetForecast = '获取15日报数据';
Blockly.ForecastHigh = '最高温度';
Blockly.ForecastLow = '最低温度';
Blockly.ForecastYmd = '年月日';
Blockly.ForecastAqi = '空气指数';
Blockly.ForecastFx = '风向';
Blockly.ForecastFl = '风力';
Blockly.ForecastType = '天气';
Blockly.SPACE_ALLOCATION = '空间分配';
Blockly.MIXLY_LIVE_WEATHER = '天气实况';
Blockly.MIXLY_3_DAY_WEATHER_FORECAST = '3天天气预报';
Blockly.MIXLY_6_LIFE_INDEXES = '6项生活指数';
Blockly.MIXLY_INFORMATION_CONFIGURATION = '信息配置';
Blockly.MIXLY_GEOGRAPHIC_LOCATION = '地理位置';
Blockly.MIXLY_API_PRIVATE_KEY = 'API私钥';
Blockly.MIXLY_LANGUAGE = '语言';
Blockly.MIXLY_CELSIUS = '摄氏度';
Blockly.MIXLY_FAHRENHEIT = '华氏度';
Blockly.MIXLY_TEMPERATURE_UNIT = '温度单位';
Blockly.MIXLY_GET_DATA_UPDATE_TIME = '获取数据更新时间';
Blockly.MIXLY_GET_SERVER_RESPONSE_STATUS_CODE = '获取服务器响应状态码';
Blockly.MIXLY_WEATHER_PHENOMENON = '天气现象';
Blockly.MIXLY_WEATHER_PHENOMENON_CODE = '天气现象代码';
Blockly.MIXLY_TODAY = '今天';
Blockly.MIXLY_TOMORROW = '明天';
Blockly.MIXLY_DAY_AFTER_TOMORROW = '后天';
Blockly.MIXLY_DAYTIME_WEATHER_PHENOMENON = '白天天气现象';
Blockly.MIXLY_DAYTIME_WEATHER_PHENOMENON_CODE = '白天天气现象代码';
Blockly.MIXLY_EVENING_WEATHER_PHENOMENON = '晚间天气现象';
Blockly.MIXLY_EVENING_WEATHER_PHENOMENON_CODE = '晚间天气现象代码';
Blockly.MIXLY_PROBABILITY_OF_PRECIPITATION = '降水概率';
Blockly.MIXLY_WIND_SPEED = '风速';
Blockly.MIXLY_WIND_RATING = '风力等级';
Blockly.MIXLY_CAR_WASH_INDEX = '洗车指数';
Blockly.MIXLY_DRESSING_INDEX = '穿衣指数';
Blockly.MIXLY_COLD_INDEX = '感冒指数';
Blockly.MIXLY_MOVEMENT_INDEX = '运动指数';
Blockly.MIXLY_TOURISM_INDEX = '旅游指数';
Blockly.MIXLY_UV_INDEX = '紫外线指数';
Blockly.MIXLY_RFID_SCAN_OK = '读到卡';
Blockly.MIXLY_RFID_SCAN_NOTAGERR = '卡无反应';
Blockly.MIXLY_RFID_SCAN_ERROR = '卡错误';
Blockly.MIXLY_WIRELESS_SOCKET = '无线插座';
Blockly.MIXLY_CREATE_MQTT_CLIENT_AND_CONNECT = '创建MQTT客户端并连接';
Blockly.MIXLY_HOT_WHEEL = '风火轮';
Blockly.MIXLY_SD_CARD_FILE_SYSTEM_MOUNT = '安装文件系统对象于路径';
Blockly.MIXLY_SD_CARD = 'SD卡';
Blockly.MIXLY_RAIN = '降雨量';
Blockly.MIXLY_RAIN_TIME = '秒内的';
Blockly.USE_MIXLY_KEY = '使用 Mixly Key';
Blockly.CONNECT_TO_MIXIO = '连接到 MixIO';
Blockly.MQTT_SEND_MESSAGE = 'MQTT发送消息';
Blockly.TO_TOPIC = '到主题';
Blockly.WHEN_THE_SUBJECT_IS_RECEIVED = '当收到主题';
Blockly.MIXLY_ESP32_SERVO_360_TOOLTIP = '设置360°舵机的旋转速度(-10~10)，负数为逆时针，正数为顺时针，绝对值越大速度越快';
Blockly.Msg.CONTROLS_OPERATOR_UNTIL = "直到";
Blockly.CONTROLS_WHILE_SHI = '时';
Blockly.MOTOR_DC = '直流电机';
Blockly.MOTOR_N = '空档';
Blockly.MOTOR_P = '刹车';
Blockly.MIXLYCAR_WHEEL_LEFT = '左轮';
Blockly.MIXLYCAR_WHEEL_RIGHT = '右轮';
Blockly.MIXLY_MIXGOCE_NRF = '无线近场通信';
Blockly.MIXLY_MIXGOCE_NRF_INIT = '初始化无线近场通信';
Blockly.MIXLY_MIXGOCE_SET_NRF = '配置无线近场通信 信道 %1 %2 广播功率 %3 %4 地址 %5 %6 数据速率 %7 %8';
Blockly.MIXLY_MIXGOCE_NRF_SEND = '无线近场通信 发送';
Blockly.MIXLY_MIXGOCE_NRF_RECEIVE = '无线近场通信 接收';
Blockly.MIXLY_MIXGOCE_SET_NRF1 = '配置无线的信道(0~125),广播功率,地址(5字节),数据速率';
Blockly.MIXLY_MIXIO_SHARE_KEY = '项目授权码';
...
Blockly.MIXLY_MIXGO_CAR_SENSOR_ONBOARD_AUTO_CHANGE = '巡线/避障自动切换';
Blockly.MIXLY_MIXGO_CAR_BATTERY_LEFT = '电池剩余电量(V)'
Blockly.MIXLY_MACHINE_WDT='看门狗'
Blockly.MIXLY_MACHINE_WDT_TIMEOUT='喂食间隔'
Blockly.MIXLY_MACHINE_WDT_INIT_TOOLTIP='初始化看门狗并设置喂养时间'
Blockly.MIXLY_MACHINE_FEED='进行喂食'
...
Blockly.MIXLY_MP_ESPNOW_RADIO_MSG_RECEIVED_CERTAIN= '当无线广播接收到特定消息';
Blockly.MIXLY_MP_ESPNOW_RADIO_RECEIVED_MSG= '无线广播接收到的消息';
Blockly.MIXLY_MP_ESPNOW_CHANNEL= '频道';
Blockly.MIXLY_MIXGO_ESPNOW_MAC= '获取本机MAC地址';
Blockly.MIXLY_MIXGO_ESPNOW_INFO= '获取信号源MAC地址及信号强度信息';
Blockly.MIXLY_MIXGO_ESPNOW_SEND= '发送消息';
Blockly.MIXLY_MIXGO_ESPNOW_SEND_MAC= '向MAC地址';
Blockly.MIXLY_MIXGO_ESPNOW_SEND_TOOLTIP= 'MAC地址为12位，如MAC为"FFFFFFFFFFFF"，则广播发送；最多发送250字节内容';
Blockly.MIXLY_MIXGO_ESPNOW_RECV= '接收消息';
Blockly.MIXLY_GAME_INIT_AS="初始化地图为";
Blockly.MIXLY_GAME_INIT="初始化地图";
Blockly.MIXLY_RE_SPIRITE="以角色为参考"
Blockly.MIXLY_GAME_TOWARD="向";
Blockly.MIXLY_GAME_MOVE="移动";
Blockly.MIXLY_GAME_STEP="步";
Blockly.MIXLY_GAME_TURN_LEFT="左";
Blockly.MIXLY_GAME_TURN_RIGHT="右";
Blockly.MIXLY_GAME_TURN="转";
Blockly.MIXLY_GAME_ISDONE="是否到达终点"
Blockly.MIXLY_GAME_ONE="地图一";
Blockly.MIXLY_GAME_TWO="地图二";
Blockly.MIXLY_GAME_THREE="地图三";
Blockly.MIXLY_GAME_FOUR="地图四";
Blockly.MIXLY_GAME_FIVE="地图五";
Blockly.MIXLY_GAME_SIX="地图六";
Blockly.MIXLY_GAME_SEVEN="地图七";
Blockly.MIXLY_GAME_EIGHT="地图八";
Blockly.MIXLY_GAME_NINE="地图九";
Blockly.MIXLY_GAME_TEN="地图十";
Blockly.MIXLY_GAME_ELE="地图十一";
Blockly.MIXLY_GAME_TWEL="地图十二";
Blockly.MIXLY_GAME_THIR="地图十三";
Blockly.MIXLY_GAME_FORT="地图十四";
Blockly.MIXLY_GAME_FIFT="地图十五";
Blockly.MIXLY_GAME_SIXT="地图十六";
Blockly.MIXLY_GAME_SEVENT="地图十七";
Blockly.MIXLY_GAME_EIGHTT="地图十八";

Blockly.MIXLY_GAME_ISPATH="侧是否存在道路？"
Blockly.MIXLY_GAME_NORTH="北";
Blockly.MIXLY_GAME_SOUTH="南";
Blockly.MIXLY_GAME_EAST="东";
Blockly.MIXLY_GAME_WEST="西";

Blockly.MIXLY_GAME_SETMAP="设置地图";
Blockly.MIXLY_GAME_LENGTH_IS="长为";
Blockly.MIXLY_GAME_WIDTH_IS="宽为";
Blockly.MIXLY_GAME_STARTPOS_IS="起点坐标为";
Blockly.MIXLY_GAME_ENDPOS_IS="终点坐标为";
Blockly.MIXLY_GAME_BACKGROUND="背景图片为";

Blockly.MIXLY_GAME_SETPATHTYPE="设置路径样式为";
Blockly.MIXLY_GAME_LAY="放置";
Blockly.MIXLY_GAME_BARRIER="障碍";
Blockly.MIXLY_GAME_COIN="金币";
Blockly.MIXLY_GAME_INIT_CHARA="初始化角色为";
Blockly.MIXLY_GAME_FACE="面朝";
Blockly.MIXLY_GAME_GETPOINT="获取角色所获分数";
Blockly.MIXLY_GAME_ISBARRIER="侧是否有障碍？";
Blockly.MIXLY_GAME_RANDOMCAROIL="随机生成小车油量";
Blockly.MIXLY_GAME_NEEDOIL="需要加油？";
Blockly.MIXLY_GAME_ISGREEN="信号灯为绿灯？";
Blockly.MIXLY_GAME_ADDOIL="进加油站加油";
Blockly.MIXLY_GAME_CHECKCIRCURIGHT="检查程序循环数目是否正确";
Blockly.MIXLY_GAME_WALL="墙";
Blockly.MIXLY_GAME_REDMARKER="红标";
Blockly.MIXLY_GAME_BLUEMARKER="蓝标";
Blockly.MIXLY_GAME_YELLOWMARKER="黄标";
Blockly.MIXLY_GAME_GREENMARKER="绿标";
Blockly.MIXLY_GAME_CHECK_WHETHER_PASS="是否经过";
Blockly.MIXLY_GAME_GET_MARKER_NUM="获取经过"
Blockly.MIXLY_GAME_NUMBER_OF_MARKER="的数目";

Blockly.MIXLY_GAME_UP="上";
Blockly.MIXLY_GAME_DOWN="下";
Blockly.MIXLY_GAME_LEFT="左";
Blockly.MIXLY_GAME_RIGHT="右";

Blockly.MIXLY_GAME_FORWARD="前";
Blockly.MIXLY_GAME_BACKWARD="后";

Blockly.MIXLY_CV_IMREAD="读入图像";
Blockly.MIXLY_CV_IMWRITE="保存图像";
Blockly.MIXLY_CV_OR_PRESS="或按任意键跳过";
Blockly.MIXLY_CV_WAITKEY_TOOLTIP="等待指定的时间（单位：毫秒）或用户按任意键，参数为0时必须用户按任意键触发程序继续运行";
Blockly.MIXLY_CV_DRAWLINE_RECT_TOOLTIP="在图片指定位置绘制指定图案，线条粗细为负值时可绘制实心矩形";
Blockly.MIXLY_CV_DESTROY_ALL="关闭所有图像窗口";
Blockly.MIXLY_CV_LINE="线条";
Blockly.MIXLY_CV_RECT="矩形";
Blockly.MIXLY_CV_DRAWLINE_BEGIN="起点";
Blockly.MIXLY_CV_DRAWLINE_END="终点";
Blockly.MIXLY_CV_DRAWLINE_COLOR="线条颜色";
Blockly.MIXLY_CV_DRAWLINE_THICKNESS="线条粗细";
Blockly.MIXLY_CV_DRAWTEXT="添加文字";
Blockly.MIXLY_CV_FACE_CLASSIFIER="创建人脸检测分类器 模型文件";
Blockly.MIXLY_CV_FACE_DETECT="进行人脸识别 使用分类器";
Blockly.MIXLY_CV_FACE_DETECT_SCALE="放缩比例";
Blockly.MIXLY_CV_FACE_DETECT_NEIGHBOR="检验特征数";
Blockly.MIXLY_CV_FACE_DETECT_RANGE="目标区域大小范围";
Blockly.MIXLY_WEB_PLACE="地点";
Blockly.MIXLY_WEB_KEY="密钥";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_WEATHER_NOW="获取天气实况";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_WEATHER_DAILY="获取天气逐日预报";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_WEATHER_HOURS="获取天气逐时预报";
Blockly.MIXLY_WEB_DAILY="天数";
Blockly.MIXLY_WEB_HOURS="小时";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_WEATHER_ALARM="获取气象灾害预警";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_LIFE_SUGGESTION="获取生活指数";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_AIR_NOW="获取空气质量实况";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_AIR_DAILY="获取空气质量逐日预报";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_TIDE_DAILY="获取24小时潮汐预报";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_GEO_SUN="获取日出日落信息";
Blockly.MIXLY_WEB_DATA_SENIVERSE_GET_GEO_MOON="获取月出月落和月相信息";
Blockly.MIXLY_DEPRECATED = "已弃用";
Blockly.MIXLY_DEPRECATED_WARNING_TEXT = "警告：此块已弃用，将在未来删除";
Blockly.LANG_LISTS_GET_VALUE_BY_INDEX_TOOLTIP = '返回数组中指定位置的值，索引从0开始。';
Blockly.LANG_LISTS_SET_VALUE_BY_INDEX_TOOLTIP = '设置数组中指定位置的值，索引从0开始。';
Blockly.MICROPYTHON_DISPLAY_FONT_SPACE = "字间距";
Blockly.MICROPYTHON_DISPLAY_YES = "是";
Blockly.MICROPYTHON_DISPLAY_NO = "否";
Blockly.MIXLY_ESP32_MONITOR_SHOW_FRAME = '逐字显示字符串';
Blockly.ME_GO_LIGHT_HEADLIGHT = '大灯';
Blockly.ME_GO_MOTOR_EXTERN = '外接';
Blockly.ME_GO_HALL_SENSOR = '霍尔传感器';
Blockly.ME_GO_HALL_SENSOR_TURN = '转数';
Blockly.ME_GO_HALL_SENSOR_DISTANCE = '距离';
Blockly.ME_GO_SENSOR_MODE_OFF = '红外关闭';
Blockly.MIXGO_ME_DISPLAY_VERTICAL = '纵向';
Blockly.MIXGO_ME_DISPLAY_HORIZONTAL = '横向';
Blockly.MIXLY_INCREMENT = '增量';
Blockly.MIXLY_UPPERBOUND = '上限';
Blockly.MIXLY_LOWERBOUND = '下限';
Blockly.MIXLY_ENCODER_CHANGED = '状态改变';
Blockly.MIXLY_ENCODER_LEFT_ROTATION = '向左旋转';
...
Blockly.MICROPYTHON_HUSKYLENS_CHANGE_ALGORTHIM = '切换至算法';
Blockly.MICROPYTHON_HUSKYLENS_UNTIL_SUCCESS = '直至成功';
Blockly.MICROPYTHON_HUSKYLENS_ALGORITHM_OBJECT_TRACKING = '物体追踪';
Blockly.MICROPYTHON_HUSKYLENS_ALGORITHM_OBJECT_RECOGNITION = '物体识别';
Blockly.MICROPYTHON_HUSKYLENS_ALGORITHM_LINE_TRACKING = '巡线';
Blockly.MICROPYTHON_HUSKYLENS_ALGORITHM_TAG_RECOGNITION = '标签识别';
Blockly.MICROPYTHON_HUSKYLENS_ALGORITHM_OBJECT_CLASSIFICATION = '物体分类';
Blockly.MICROPYTHON_HUSKYLENS_ALGORITHM_QR_CODE_RECOGNTITION = '二维码识别';
Blockly.MICROPYTHON_HUSKYLENS_ALGORITHM_BARCODE_RECOGNTITION = '条形码识别';
Blockly.MICROPYTHON_HUSKYLENS_COMMAND_REQUEST = '请求一次数据 存入结果';
Blockly.MICROPYTHON_HUSKYLENS_READ_LEART_ID_COUNT = '已学习ID总数';
Blockly.MICROPYTHON_HUSKYLENS_GET_FROM_RESULT = '从结果中获取';
Blockly.MICROPYTHON_HUSKYLENS_IS_APPEAR = '是否在画面中';
Blockly.MICROPYTHON_HUSKYLENS_IS_LEARNED = '是否已学习';
Blockly.MICROPYTHON_HUSKYLENS_NEAR_CENTERED = '靠近中心';
Blockly.MICROPYTHON_HUSKYLENS_X_CENTERED = 'X中心';
Blockly.MICROPYTHON_HUSKYLENS_Y_CENTERED = 'Y中心';
Blockly.MICROPYTHON_HUSKYLENS_X_ORIGIN = 'X起点';
Blockly.MICROPYTHON_HUSKYLENS_Y_ORIGIN= 'Y起点';
Blockly.MICROPYTHON_HUSKYLENS_X_TARGET = 'X终点';
Blockly.MICROPYTHON_HUSKYLENS_Y_TARGET = 'Y终点';
Blockly.MICROPYTHON_HUSKYLENS_ORDER = '第';
Blockly.MICROPYTHON_HUSKYLENS_ORDER_END = '个';
Blockly.MICROPYTHON_HUSKYLENS_SUM = '总数';
Blockly.MICROPYTHON_HUSKYLENS_LEARN_ONCE = '自动学习一次';
Blockly.MICROPYTHON_HUSKYLENS_FORGET = '遗忘当前算法的所有学习数据';
Blockly.MICROPYTHON_HUSKYLENS_SET_CURRENT = '设置当前算法';
Blockly.MICROPYTHON_HUSKYLENS_NAME = '名字为';
Blockly.MICROPYTHON_HUSKYLENS_SCREEN_TEXT = '屏幕叠加显示文字';
Blockly.MICROPYTHON_HUSKYLENS_SCREEN_CLEAR = '清除屏幕显示的文字';
Blockly.MICROPYTHON_HUSKYLENS_TRIGGER = '触发';
Blockly.MICROPYTHON_HUSKYLENS_SAVE_SDCARD = '保存到SD卡';
Blockly.MICROPYTHON_HUSKYLENS_PHOTO = '拍照';
Blockly.MICROPYTHON_HUSKYLENS_SCREENSHOT = '截屏';
Blockly.MICROPYTHON_HUSKYLENS_SAVE_AS = '保存';
Blockly.MICROPYTHON_HUSKYLENS_LOAD = '加载';
Blockly.MICROPYTHON_HUSKYLENS_SDCARD_MODEL = '当前算法数据为SD卡';
Blockly.MICROPYTHON_HUSKYLENS_MODEL_NUM = '号模型';
Blockly.MIXLY_ESP32_MAX30102 = "心率血氧传感器";
Blockly.MIXLY_ESP32_MAX30102_IR = "心率";
Blockly.MIXLY_ESP32_MAX30102_RED = "血氧";
Blockly.MIXLY_ESP32_APDS9960 = "手势传感器";
...
Blockly.Msg.MPYTHON_DISPLAY_MODE_1 = '绘制';
Blockly.Msg.MPYTHON_DISPLAY_HOLLOW = '空心';
Blockly.Msg.MPYTHON_DISPLAY_SOLID = '实心';
Blockly.Msg.MPYTHON_DISPLAY_SHAPE_RECT_MESSAGE0 = '%1 %2 矩形 %3 x %4 y %5 宽 %6 高 %7';
Blockly.Msg.MPYTHON_DISPLAY_SHAPE_RECT_TOOLTIP = '';
Blockly.Msg.mpython_horizontal = '水平';
Blockly.Msg.mpython_vertical = '垂直';
Blockly.Msg.MPYTHON_DISPLAY_HVLINE_MESSAGE0 = '%1 %2 线 %3 x %4 y %5 长度 %6';
Blockly.Msg.MPYTHON_DISPLAY_HVLINE_TOOLTIP = '';
Blockly.Msg.mpython_display_hline_0 ='擦除';
Blockly.Msg.mpython_display_hline_1 = '绘制';
Blockly.Msg.mpython_display_line_MESSAGE0 ='%1 线%2 x1 %3  y1 %4 到  x2 %5 y2 %6';
Blockly.Msg.mpython_display_line_TOOLTIP = '';
Blockly.MIXLY_MIDI = '蜂鸣器';
Blockly.MIXLY_CODE_RATE = '编码率';
Blockly.MIXLY_SPREADING_FACTOR = '扩频因子';
Blockly.MIXLY_TX_POWER = '发射功率';
Blockly.MIXLY_SIGNAL_BANDWIDTH = '带宽';
